...
class Parser {
    ...
    private String getCalculationResult(String expression) throws CalcException {
        ...
        Var result = VarFabric.createVar(operands.get(0));
    ...
    private int getIndexOfOperation(List<String> operations) throws CalcException {
        ...
        if (index > -1)
            ...
            throw new CalcException(ResMan.INSTANCE.get(Errors.ERROR_UNEXPECTED_RESULT));
    }
    ...
    private String oneOperation(String operandOne, String operationToDo, String operandTwo) throws CalcException {
        ...
        if (one == null || two == null) {
            System.err.println(ResMan.INSTANCE.get(Errors.OPERATION) + " " + operationToDo + " "
                    + ResMan.INSTANCE.get(Errors.IMPOSSIBLE));
            return null;
        }
